...
"'5','1&ndash;10. 1 disables corroboration; 3&ndash;7 is the useful range.'],"
...
"'3 s','1&ndash;600 s. Raise it on a busy feeder to save SD space and API calls.'],"
...
"'60%','15&ndash;95%. Lower admits more (riskier) automatic labels; higher leaves more events for"
" manual review.'],"
...
"'(no location)','Any capital in the list; sent as lat,lng with each identification call.'],"
