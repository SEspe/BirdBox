...
"<p class='sts' style='margin-top:2px'>Northern Europe restricts IDs to the ~150 regional "
"species in the Norway allowlist, dropping any out-of-region result. On iNaturalist online "
"this rejects a geographically-impossible top hit (e.g. Pica hudsonia, the American magpie) "
"and takes the best in-region candidate instead (e.g. Pica pica); on the on-device model it "
"masks out-of-region classes.</p>"
