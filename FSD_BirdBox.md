...
|---|---|---|---|---|
| **ESP32-S3 camera board** (e.g. Seeed XIAO ESP32S3 Sense, Freenove ESP32-S3-WROOM CAM, or ESP32-S3-EYE) | ESP32-S3 (dual-core LX7, vector instructions) | OV2640 / OV3660 | 8 MB (required) | Primary target — PSRAM and the S3's AI acceleration are needed for frame buffering + on-device inference |
